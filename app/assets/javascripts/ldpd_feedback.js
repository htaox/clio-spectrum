...
LWEB.setupFeedbackDialog = function() {
    $('<div id="feedback_dialog"><a id="close_feedback_dialog" href="#" onclick="LWEB.hideFeedbackDialog();"><span class="glyphicon glyphicon-remove"></span></a><iframe width="600" height="400" src="https://culwcm.cul.columbia.edu/clio_feedback?current_page=' + window.location.href + '"></iframe></div>').hide().appendTo('body');
    $('#feedback_dialog').css(
        {
        'z-index':'10000',
        'position':'absolute'
