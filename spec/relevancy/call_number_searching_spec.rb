...
describe 'Testing Call Number Searching', :skip_travis do
  it 'Basic Call-Number, searching all-fields or call-number only' do
    ...
    resp = solr_resp_doc_ids_only('q' => '{!edismax qf=location_call_number_txt pf=location_call_number_txt}AA966 B25 R11', defType: 'lucene')
  ...
  it 'Call-Number first token, searching all-fields or call-number only' do
    ...
    resp = solr_resp_doc_ids_only('q' => '{!edismax qf=location_call_number_txt pf=location_call_number_txt}AA966', defType: 'lucene')
  ...
  it 'Zine Call-Number searching' do
    resp = solr_resp_doc_ids_only('q' => '{!edismax qf=location_call_number_txt pf=location_call_number_txt}Zines', defType: 'lucene')

    expect(resp.size).to be >= 4500
    expect(resp.size).to be <= 5500
    ...
    resp = solr_resp_doc_ids_only('q' => '{!edismax qf=location_call_number_txt pf=location_call_number_txt}Zines W474o', defType: 'lucene')
